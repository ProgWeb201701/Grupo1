...
class PageView {
    ...
    function showMenuLateral() {
        echo '<div id="mySidenav" class="sidenav">
                <a class="sideNavTitulo" href="index.php#tutoriais" >Duo </a>
    ...
    function showMenuSuperior() {
        ...
        if($page == "indexPrincipal.php"){
            echo '<li><a id="menuativo" href="indexPrincipal.php" onclick="responsiveMenu()" >Home</a></li>';
        } else {
            echo '<li><a  href="indexPrincipal.php" onclick="responsiveMenu()" >Home</a></li>';
        }
