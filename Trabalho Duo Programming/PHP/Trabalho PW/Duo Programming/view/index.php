...
//teste
//include_once '../controller/ControllerSessao.php';
//$usuario = new ControllerSessao();
//$userID = $_SESSION['userID'];
//if (!$usuario->getSessao()){
//  header("location:http://localhost/Trabalho%20PW/Duo%20Programming/view/login.php");
//}
//else{
//  header("location:http://localhost/Trabalho%20PW/Duo%20Programming/view/index.php");
//}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="thumbnail">
                                ...
                                <div class="caption">
                                    <a href="Operadores.php" ><h4>-Operadores Aritméticos/Lógicos</h4></a>
                        ...
                        <div class="col-md-3">
                            <div class="thumbnail">
                                ...
                                <img src="imgs/cicone.png" alt="Fjords" style="width:50%">
                                <div class="caption">
                                    <a href="Controladores.php"><h4>-Controladores de Fluxo</h4></a>
