...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="thumbnail">
                <a href="java.php" </a>
                <img src="../imagen/javaIcone.png" alt="Lights" style="width:100%">
                    <div class="caption">
                        <h2>Java</h2>
                    </div>
        ...
        <div class="col-md-4">
            <div class="thumbnail">
                     <a href="php.php"  </a>
                    <img src="../imagen/iconePhp.jpg" alt="Nature" style="width:100%">
                    <div class="caption">
                        <h2>PHP</h2>
                    </div>
        ...
        <div class="col-md-4">
            <div class="thumbnail">
                    <a href="c.php"  </a>
                    <img src="../imagen/cicone.png" alt="Fjords" style="width:100%">
                    <div class="caption">
                        <h2>C</h2>
                    </div>
